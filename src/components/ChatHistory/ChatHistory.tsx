		...
		>
			<div className="relative flex flex-col items-center justify-start w-full h-full gap-4 px-2">
				<div className="flex justify-between w-full gap-x-2">
					<button
						className="flex-1 py-2 font-medium transition-colors border rounded-lg hover:bg-neutral-600 border-neutral-500 dark:hover:bg-neutral-700 hover:border-neutral-400"
						onClick={newThread}
					>
						New Chat
					</button>
					<button
						className="p-2 font-semibold transition-colors border rounded-lg hover:bg-neutral-600 border-neutral-500 dark:hover:bg-neutral-700 hover:border-neutral-400"
						onClick={openConfig}
					>
